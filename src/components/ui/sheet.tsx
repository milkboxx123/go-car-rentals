...
const sheetVariants = cva(
  [
    "fixed z-50 flex flex-col gap-4 border-go-border bg-go-paper shadow-popover duration-modal",
...
function SheetHeader({
  ...
  return (
    <div
      className={cn("flex flex-col space-y-2 p-6 pb-0 text-left", className)}
      {...props}
    />
  );
}
...
function SheetFooter({
  ...
  return (
    <div
      className={cn(
        "mt-auto flex flex-col gap-2 p-6 pt-0 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    />
